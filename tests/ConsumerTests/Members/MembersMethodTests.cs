...
//
// namespace ConsumerTests.MembersMethodTests;
//
// public class Tests
// {
//     [Fact]
...
//     {
//         MyString.IsDefined("One").Should().BeTrue();
//         MyString.IsDefined("Two").Should().BeTrue();
//         MyString.IsDefined("Three").Should().BeTrue();
//
//         MyString.List().Should().ContainInOrder(MyString.One, MyString.Two, MyString.Three);
//     }
//
//     [Fact]
//     public void IntTests()
//     {
//         MyInt.IsDefined(0).Should().BeTrue();
//         MyInt.IsDefined(1).Should().BeTrue();
//         MyInt.IsDefined(2).Should().BeTrue();
//
//         MyInt.List().Should().ContainInOrder(MyInt.One, MyInt.Two, MyInt.Three);
//     }
//         
//     [Fact]
...
//             // ticks as an Int.MaxValue is 2147483647, which is 2,147,483,647 / 10m, which is ~214 seconds, which 3 minutes, 34 seconds
//             DateTimeOffsetInstance.ticks_as_int.Value.Should()
//                 .BeCloseTo(DateTimeOffsetInstance.ticks_as_int, TimeSpan.FromTicks(7483647));
//         }
//     }
//
//     [Fact]
...
// {
//     static MyString() => Members("One, Two   , Three");
// }
//
// [Intellenum]
// public partial class MyInt
// {
//     static MyInt() => Members("One, Two   , Three");
// }
//  
//     
