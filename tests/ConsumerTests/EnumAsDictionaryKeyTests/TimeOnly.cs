...
[Intellenum(typeof(TimeOnly))]
public partial class EmployeeTypeTimeOnly
{
    public static readonly EmployeeTypeTimeOnly Manager = new(new TimeOnly(12, 13, 59));
    public static readonly EmployeeTypeTimeOnly Operator = new(new TimeOnly(14, 30, 59));
}
